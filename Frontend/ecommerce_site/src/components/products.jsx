...
//         <img
//           src={currentImage ? `http://localhost:8000${currentImage}` : "/default-image.jpg"}
//           alt={name || "Product Image"}
//           className="w-full h-56 object-cover rounded-lg mb-2"
//         />
//         <h2 className="text-lg font-bold">{name || "No Name Available"}</h2>
//         <p className="text-sm opacity-75 mt-2">{description || "No Description Available"}</p>
//       </div>
...
// // // Add default props in case props are missing
